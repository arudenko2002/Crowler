 ...
 */
public class RetrieveReportsHist {
	...
	public static void setCleanupFileList(List<String> cleanupFileList) {
		RetrieveReportsHist.cleanupFileList = cleanupFileList;
	}
...
/*			Class.forName("org.postgresql.Driver");
		    ...
		    ResultSet rs = stmt.executeQuery( "SELECT * FROM datapipeline.youtube_hist_scheduler" );
...
*/			// Create a listener for automatic refresh OAuthAccessToken
	...
	private static void upload(String path2) throws InterruptedException {
		try {
			...
			String s3OutputPath = FileUtil.getS3OutputPath(fileNameFromPath, youtubeModel.getPartitionDate(),
	 ...
	 */
	public static void main(String[] args) throws InterruptedException, GoogleJsonResponseException {
