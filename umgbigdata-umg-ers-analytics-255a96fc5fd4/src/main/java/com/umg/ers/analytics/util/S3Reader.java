...
public class S3Reader {
	...
	private static String sourcePath = "data-pipeline/automation/playlist-premium/streaming";
	...
	public static void main(String[] args) throws IOException {
		...
		Set<String> s3feed = s3Reader.fileListFrmS3(bucketName,sourcePath);
		System.out.println(" size " + s3feed.size());
	}
	public  Set<String> fileListFrmS3(String bucketName, String sourcePath) throws IOException{
		Set<String> s3Records = new HashSet<String>();
		 try {
	           System.out.println("Listing objects >>> 1");
	            ...
	            do {
	                ...
	                for (S3ObjectSummary objectSummary : objectListing.getObjectSummaries()) {
	                	System.out.println(" :: object summery >>  " + objectSummary.getKey());
	                	//s3Records =	readFromS3(bucketName, objectSummary.getKey());
	...
	private static Set<String> readFromS3(String bucketName, String key) throws IOException {
		Set<String> s3Records = new HashSet<String>();
	...
	public Set<String> fileListFrmS3l(String bucketName, String sourcePath) throws IOException{
		Set<String> s3Records = new HashSet<String>();
		 try {
